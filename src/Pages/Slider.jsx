        ...
        <div className="carousel lg:h-[550px] w-full">
            <div id="slide1" className="carousel-item relative  w-full">
                ...
                <div className='absolute bg-black opacity-70 text-2xl md:text-4xl  top-6 font-semibold md:top-20 lg:top-24 left-16 md:left-60 lg:left-[80px] rounded-xl py-3 md:py-16 px-8 space-y-3'>
                    ...
                    <Link to='https://brandshop-client.web.app/'><button className='mt-4 bg-white text-lg p-2 rounded-lg' >Buy now</button></Link>
                </div>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className='absolute bg-black opacity-70 text-2xl md:text-4xl  top-6 font-semibold md:top-20 lg:top-24 left-16 md:left-60 lg:left-[980px] rounded-xl py-3 md:py-16 px-8 space-y-3'>
