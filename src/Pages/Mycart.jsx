...
const Mycart = () => {
    ...
    const [deleteCart, setDeleteCart] = useState(addedProducts)
    ...
    return (       
        ...
        <div>
            ...
            <div className='grid md:grid-cols-3 mt-8'>
                {
                    cart.map(singleCart => <Cart key={singleCart._id} singleCart={singleCart} deleteCart={deleteCart} setDeleteCart={setDeleteCart}></Cart>)
                }
            </div>
