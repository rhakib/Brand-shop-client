...
const Cart = ({ singleCart, cart, setCart }) => {
    ...
    return (
        <>
            {
                cart? <div className="w-full h-[550px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-200 ">
                ...
                <div className="px-5 py-2 pb-2">
                    ...
                    <h5 className="text-lg font-semibold tracking-tight text-gray-900 ">{brand}</h5>
