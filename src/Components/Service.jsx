                    ...
                    <div className="grid lg:grid-cols-3 gap-9 mt-10 md:mt-28">
                        <div className="sm:flex  gap-4 lg:block space-y-6 sm:space-y-0 lg:space-y-6">
                            <div className="flex items-center gap-1">
                                <BsFillPlayFill className='text-[#406bd0] text-6xl'></BsFillPlayFill>
                                <div className="">
                                    <h3 className="text-2xl text-[#292c39] font-semibold">Exceptional Sound Quality</h3>
                            ...
                            <div className="flex lg:mt-7 items-center gap-1">
                                <BsFillPlayFill className='text-[#406bd0] text-7xl'></BsFillPlayFill>
                                <div className="">
                                    <h3 className="text-2xl text-[#292c39] font-semibold">Versatile and User-Friendly</h3>
                        ...
                        <div className="sm:flex gap-4 lg:block space-y-6 sm:space-y-0 lg:space-y-6">
                            <div className="flex items-center gap-1">
                                <BsFillPlayFill className='text-[#406bd0] text-7xl'></BsFillPlayFill>
                                <div className="">
                                    <h3 className="text-2xl text-[#292c39] font-semibold">Innovative Design</h3>
                            ...
                            <div className="flex lg:mt-7 items-center gap-1">
                                <BsFillPlayFill className='text-[#406bd0] text-7xl'></BsFillPlayFill>
                                <div className="">
                                    <h3 className="text-2xl text-[#292c39] font-semibold">Superior Build and Durability</h3>
